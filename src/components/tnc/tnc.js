  ...
  return (
    <>
      ...
      <div class="container">
        ...
        <h1 className="welcometitle" style={{ color:'#1d0c35', textAlign:'center',fontWeight: '500'}}>Welcome to Marcaids!</h1>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of Marcaids's Website, located at{" "}
          <a href="http://www.marcaids.com">www.marcaids.com</a>.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Marcaids if you do not agree to
        ...
        <ul>
          <li>
            <strong>"Client", "You", "Your"</strong> refers to you, the person
            logging onto this website and compliant with the Company's terms and
            conditions.
          </li>
          <li>
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By accessing Marcaids, you agreed to use
          cookies in agreement with Marcaids's Privacy Policy.
        </p>
        <p>
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, Marcaids and/or its licensors own the
          intellectual property rights for all material on Marcaids. All
          intellectual property rights are reserved. You may access this from
          Marcaids for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Marcaids</li>
          <li>Sell, rent, or sub-license material from Marcaids</li>
          <li>Reproduce, duplicate, or copy material from Marcaids</li>
          <li>Redistribute content from Marcaids</li>
        </ul>
        ...
        <p>
          ...
          Marcaids does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Marcaids, its agents, and/or affiliates. Comments reflect
          the views and opinions of the person who posts their views and
          opinions. To the extent permitted by applicable laws, Marcaids shall
          not be liable for the Comments or for any liability, damages, or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
        </p>
        <p>
          Marcaids reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Marcaids a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Marcaids; and (d) the link is
        ...
        <p>
          ...
          sending an e-mail to Marcaids. Please include your name, your
        ...
        <p>
          No use of Marcaids's logo or other artwork will be allowed for linking
        ...
        <div className="contentliability">
        ...
        <div className="reservationofrights">
