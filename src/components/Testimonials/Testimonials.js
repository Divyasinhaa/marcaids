...
const Testimonials = () => {
  return (
    <>
      <div className="relative w-full h-auto lg:bg-[#F5D6C2] bg-[#7ba881] flex items-center justify-center overflow-hidden">
        {/* Semi-Circle Background */}
        <div className="absolute w-[130%] h-[160%] bg-[#7ba881] rounded-full top-0 right-[40%]"></div>

        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {/* Content Section */}
            <div className="md:col-span-2 flex flex-col justify-center items-center text-center text-white z-10 p-4">
            ...
            <div className="md:col-span-3 w-full md:w-[85%] lg:w-[75%] mx-auto" style={{ fontFamily: 'Imprima, sans-serif' }}>
              <Carousel>
                {/* Testimonial Card 1 */}
                <Carousel.Item>
                  <Card className="testimonial-cards bg-transparent">
                    <div className="relative bg-white/30 p-8 lg:rounded-[160px] rounded-[100px] mt-10 mb-5 lg:ml-10 lg:mr-10 sm:ml-0 sm:mr-0 lg:h-[700px] sm:h-[500px]">
                      <div className="flex flex-col items-center text-center">
                        <div className="testimonial-quote text-2xl lg:text-[32px] md:text-xl text-gray-700 lg:mb-4 sm:mb-0 lg:mt-12">
                          <p>
                ...
                <Carousel.Item>
                  <Card className="testimonial-cards bg-transparent">
                    <div className="relative bg-white/30 p-8 lg:rounded-[160px] rounded-[100px] mt-10 mb-5 lg:ml-10 lg:mr-10 sm:ml-0 sm:mr-0 lg:h-[700px] sm:h-[500px]">
                      <div className="flex flex-col items-center text-center">
                        <div className="testimonial-quote text-2xl lg:text-[32px] md:text-xl text-gray-700 lg:mb-4 sm:mb-2 lg:mt-12 sm:mt-2 ">
                          <p>
